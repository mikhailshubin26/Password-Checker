...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelResults.setLayoutDirection(Qt.LayoutDirection.LeftToRight)
        self.labelResults.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.labelLogo = QLabel(self.centralwidget)
        self.labelLogo.setObjectName(u"labelLogo")
        self.labelLogo.setGeometry(QRect(200, 50, 251, 101))
        self.pushButtonSupport = QPushButton(self.centralwidget)
        self.pushButtonSupport.setObjectName(u"pushButtonSupport")
        self.pushButtonSupport.setGeometry(QRect(320, 410, 161, 51))
        self.pushButtonSupport.setFont(font2)
        self.pushButtonFAQ = QPushButton(self.centralwidget)
        self.pushButtonFAQ.setObjectName(u"pushButtonFAQ")
        self.pushButtonFAQ.setGeometry(QRect(150, 410, 161, 51))
        self.pushButtonFAQ.setFont(font2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"1.1.0", None))
        self.pushButtonCheck.setText(QCoreApplication.translate("MainWindow", u"\u041f\u0440\u043e\u0432\u0435\u0440\u0438\u0442\u044c", None))
        self.labelResults.setText("")
        self.labelLogo.setText("")
        self.pushButtonSupport.setText(QCoreApplication.translate("MainWindow", u"\u041f\u043e\u0434\u0434\u0435\u0440\u0436\u0430\u0442\u044c", None))
        self.pushButtonFAQ.setText(QCoreApplication.translate("MainWindow", u"F.A.Q.", None))
    # retranslateUi
